...
<div class="main-container">
			 ...
			 <div class="row">  
			   <div class="col-sm-3">
			   <img class="image1" src="images/<%=resultSet.getString(2) %>" height = "200px" width="200px" />
			   </div>
			   <div class="col-sm-9">
			   <label class="label1">House Id : <%=resultSet.getInt(1) %></label><br>
			   <label class="label1">Type : <%=resultSet.getString(5) %></label><br> 
			   <label class="label1">Rooms: <%=resultSet.getString(6) %></label><br>
			   <label class="label1">Price : <%=resultSet.getInt(7) %> </label><br>
			   <label class="label1">Location : <%=resultSet.getString(3) %></label><br>
